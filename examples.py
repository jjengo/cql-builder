...
if __name__ == '__main__':
	...
	# SELECT * FROM ...
	(QueryBuilder.select_from(column_family)
		.all()
	)
	...
	(QueryBuilder.delete_from(column_family)
		.where(eq('last', 'bar'))
	)
	...
	# TRUNCATE ...
	QueryBuilder.truncate(column_family)
